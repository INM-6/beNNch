...
#### Step 1.1: Initialize submodules
...
#### Step 1.2: Change URL of results repository
...
#### Step 1.4: Install `plot` as a Python module
...
### Step 3: Install NEST as a module with Builder
...
#### Step 3.2: Select version to install

![image](walk-through_images/03_builder.png)
...
#### Step 3.5: Load NEST as a module
...
### Step 4: Configuring the benchmark
![image](walk-through_images/04_benchmark_config.png)
...
![image](walk-through_images/05_run_simulations.png)
...
### Step 6: Inspect running jobs
![image](walk-through_images/06_submitted_jobs.png)

The jobs are submitted with a dependency: first, the build job finishes; afterwards, the simulation jobs run.

### Step 7: Simulation output files --- location
![image](walk-through_images/07_created_files.png)
...
### Step 8: Simulation output files --- content
![image](walk-through_images/08_created_files_content.png)
...
### Step 9: Where to store results
![image](walk-through_images/09_gitmodules.png)
...
### Step 10: Analysis config
![image](walk-through_images/10_analysis_config.png)
...
![image](walk-through_images/11_run_analysis.png)
...
![image](walk-through_images/12_results_content.png)
...
### Step 13: Sync results
![image](walk-through_images/13_git_annex_sync.png)

Next, we need to sync the repository in order to add the new results.

### Step 14: Sort and filter results
![image](walk-through_images/14_git_annex_view.png)
...
### Step 15: Create flipbook
![image](walk-through_images/15_run_flipbook.png)
...
### Step 16: View flipbook
![image](walk-through_images/16_flipbook.png)
