...
# ! of a loop.
dx = layerProps['extent'][0]/layerProps['columns']
dy = layerProps['extent'][1]/layerProps['rows']
pos = [[indx_x * dx, indx_y * dy] for indx_x in range(layerProps['columns']) for indx_y in range(layerProps['rows']) ]

[nest.SetStatus([n], {"phase": phaseInit(pos[n-2],
                                         Params["lambda_dg"],
                                         Params["phi_dg"])})
...
logger.log('{} # sim_time'.format(SimulationTime))
